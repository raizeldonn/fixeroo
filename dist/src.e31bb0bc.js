...
class Toast {
  ...
  // set a few of its vars
  // and set the wrapping container that we put the toast into
  static init() {
...
class Auth {
  ...
  async signUp(accessLevel, firstName, lastName, email, password, userData) {
    let fail = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
    let user = {
      "email": email,
      "firstName": firstName,
      "lastName": lastName,
    ...
    if (accessLevel == 1) {
      ...
      response = await fetch("".concat(_App.default.apiBase, "/user"), {
        method: 'PUT',
        body: userData
      });
    } else {
      //create a new user in the handymen table
      response = await fetch("".concat(_App.default.apiBase, "/handymen"), {
        method: 'PUT',
        headers: {
  ...
  async signIn(email, password, userData) {
    let fail = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    const response = await fetch("".concat(_App.default.apiBase, "/handymen/").concat(email)); // if response not ok
    ...
    if (data.Item.password == password) {
      _Toast.default.show("Welcome  ".concat(data.Item.firstName)); // set current user


      this.currentUser = data.Item; // redirect to home

      _Router.default.init();

      (0, _Router.gotoRoute)('/');
    } else {
      _Toast.default.show("Incorrect Password");
  ...
  signOut() {
    _Toast.default.show("You are signed out"); // redirect to sign in    
...
exports.default = _default;
},{"./App":"App.js","./Router":"Router.js","./views/partials/splash":"views/partials/splash.js","lit-html":"../node_modules/lit-html/lit-html.js","./Toast":"Toast.js"}],"../node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {
...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js","fs":"../node_modules/parcel-bundler/src/builtins/_empty.js"}],"HandymanAPI.js":[function(require,module,exports) {
"use strict";
...
class HandymanAPI {
  async getHandymen() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/handymen")); // if response not ok
...
var _HandymanAPI = _interopRequireDefault(require("../../HandymanAPI"));
...
class HomeView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/handymen'), () => (0, _Router.gotoRoute)('/signup'));
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../HandymanAPI":"HandymanAPI.js","../../Toast":"Toast.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
class SignInView {
  ...
  signInSubmitHandler(e) {
    ...
    _Auth.default.signIn(email, password, formData, () => {
...
class SignUpView {
  ...
  signUpSubmitHandler(e) {
    ...
    _Auth.default.signUp(accessLevel, firstName, lastName, email, password, formData, () => {
      submitBtn.removeAttribute('loading');
    });
  }
...
class UserAPI {
  async postImage(firstName, lastName, image, reader) {
    ...
    let response = await fetch("".concat(_App.default.apiBase, "/image"), {
      method: 'PUT',
      headers: {
        "Content-Type": "application/json"
      },
  ...
  async addReview(email, rating, message) {
    ...
    let response = await fetch("".concat(_App.default.apiBase, "/handymen/").concat(email, "/review"), {
      method: 'PUT',
      headers: {
        "Content-Type": "application/json"
      },
  ...
  async updateUser(email, password, firstName, lastName, field, experience, price, neatness, safety, pets, policeCheck) {
    // validate
    if (!email) return;
    let user = {
      "email": email,
    ...
    let response = await fetch("".concat(_App.default.apiBase, "/handymen/").concat(email), {
      method: 'PUT',
      headers: {
        "Content-Type": "application/json"
      },
  ...
  async getUser(email) {
    // validate
    if (!email) return; // fetch the json data
...
exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js","fs":"../node_modules/parcel-bundler/src/builtins/_empty.js"}],"../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
...
function _templateObject13() {
  const data = _taggedTemplateLiteral(["\n              <sl-input name=\"safety\" label=\"Safety Concious (between 0 to 100) \" pattern=\"^[1-9][0-9]?$|^100$\" value=\"", "\"></sl-input>\n              "]);
...
function _templateObject11() {
  const data = _taggedTemplateLiteral(["\n              <sl-input name=\"neatness\" label=\"Works Neatly (between 0 to 100) \" pattern=\"^[1-9][0-9]?$|^100$\" value=\"", "\"></sl-input>\n              "]);
...
function _templateObject9() {
  const data = _taggedTemplateLiteral(["\n              <sl-input name=\"price\" label=\"Price per hour (AUD) \" placeholder=\"$\" value=\"", "\">\n              <span slot='prefix'>$</span>\n              </sl-input>"]);
...
function _templateObject7() {
  const data = _taggedTemplateLiteral(["\n              <sl-input type=\"number\" name=\"experience\" label=\"Years of Experience\"  value=\"", "\" placeholder=\"Years of Experience\"></sl-input>\n              "]);
...
class EditProfileView {
  ...
  async updateProfileSubmitHandler(e) {
    ...
    const submitBtn = document.querySelector('.submit-btn');
    submitBtn.setAttribute('loading', ''); // UserAPI.uploadProfileImage(avatar)
    ...
    try {
      ...
      if (profileImage.files[0] != undefined) {
        await _UserAPI.default.uploadProfileImageS3(firstName, lastName, profileImage.files[0]);
      }

      const updatedUser = await _UserAPI.default.updateUser(_Auth.default.currentUser.email, _Auth.default.currentUser.password, firstName, lastName, field, experience, price, neatness, safety, pets, policeCheck);
      this.render();
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), this.updateProfileSubmitHandler.bind(this), this.user.Item.firstName, this.user.Item.lastName, this.user.Item.field == null ? (0, _litHtml.html)(_templateObject4()) : (0, _litHtml.html)(_templateObject5(), this.user.Item.field), this.user.Item.experience == null ? (0, _litHtml.html)(_templateObject6()) : (0, _litHtml.html)(_templateObject7(), this.user.Item.experience), this.user.Item.price == null ? (0, _litHtml.html)(_templateObject8()) : (0, _litHtml.html)(_templateObject9(), this.user.Item.price), this.user.Item.neatness == null ? (0, _litHtml.html)(_templateObject10()) : (0, _litHtml.html)(_templateObject11(), this.user.Item.neatness), this.user.Item.safety == null ? (0, _litHtml.html)(_templateObject12()) : (0, _litHtml.html)(_templateObject13(), this.user.Item.safety), this.user.avatar ? (0, _litHtml.html)(_templateObject14(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject15())));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/handymen.js":[function(require,module,exports) {
"use strict";
...
function _templateObject13() {
  const data = _taggedTemplateLiteral(["\n        \n          <sl-card class=\"handyman-card\">\n          <h2>", " ", "</h2>\n          <hr class='grey-line' />\n          <sl-avatar class='handyman-dialog-avatar' style=\"--size: 6rem;\" image=\"https://handymen-avatars.s3.amazonaws.com/", "", ".jpg\" alt=\"cleaner avatar\"></sl-avatar>\n          <p>Field: ", "</p>\n          <p>$ ", " / hour</p>\n\n          <sl-button class='more-btn' @click=", ">See More</sl-button>\n          <sl-button class='book-btn' @click=", ">Book</sl-button>\n            </div>\n          </div>\n        </sl-card>\n\n          "]);
...
function _templateObject11() {
  const data = _taggedTemplateLiteral(["<p>Loading Handymen</p><sl-spinner></sl-spinner>"]);
...
function _templateObject10() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Handymen\" user=", "></va-app-header>\n      \n      <div class=\"page-content\">\n        \n        ", "\n      </div>\n     \n    "]);
...
function _templateObject9() {
  const data = _taggedTemplateLiteral(["<div class='checkbox'><sl-icon style=\"color:grey;\" name=\"check-square\"></sl-icon><span> Ok with pets</span></div>"]);
...
function _templateObject7() {
  const data = _taggedTemplateLiteral(["<div class='checkbox'><sl-icon style=\"color:grey;\" name=\"check-square\"></sl-icon><span> Police Check</span></div>"]);
...
function _templateObject5() {
  const data = _taggedTemplateLiteral(["\n              <sl-rating readonly class='handyman-dialog-rating' value=\"", "\"></sl-rating>"]);
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["\n          <h2>", " ", "</h2>\n          <hr class='grey-line' />\n          <div class='wrap'>\n            <div class='handyman'>\n              <sl-avatar class='handyman-dialog-avatar' style=\"--size: 6rem;\" image=\"https://handymen-avatars.s3.amazonaws.com/", "", ".jpg\" alt=\"cleaner avatar\"></sl-avatar>\n              ", "\n              \n              <p>Field: ", "</p>\n              <p>$", " /hour</p>\n            </div>\n\n            <div class='info'>\n              <p>Years of Experience: ", "</p>\n              <p>Works Neatly</p>\n              <sl-progress-bar percentage=\"", "\" style=\"--height: 6px; --indicator-color: var(--brand-color);\"></sl-progress-bar>\n              <p>Safety Conscious</p>\n              <sl-progress-bar percentage=\"", "\" style=\"--height: 6px; --indicator-color: var(--brand-color);\"></sl-progress-bar>\n              ", "\n              ", "\n\n              <sl-button class='more-btn' @click=", ">Write a Review</sl-button>\n              <sl-button class='book-btn' @click=", ">Book</sl-button>\n            </div>\n          </div>\n    "]);
...
class HandymenView {
  ...
  async getHandymen() {
    try {
      let handymenItems = await _HandymanAPI.default.getHandymen();
  ...
  bookingSubmitHandler(e) {
    ...
    e.preventDefault(); //atm data is not being sent anywhere
    //we simply show a notification to the user

    _Toast.default.show('booking request sent to cleaner. the cleaner will contact you shortly');
  ...
  bookHandler(handyman) {
    ...
    this.bookingDialog.className = 'booking-dialog'; //add content

    const dialogContent = (0, _litHtml.html)(_templateObject(), handyman.firstName, handyman.lastName, this.bookingSubmitHandler.bind(this), _Auth.default.currentUser._id, handyman.firstName);
    (0, _litHtml.render)(dialogContent, this.bookingDialog); //append to document.body

    document.body.append(this.bookingDialog); //show the dialog

    this.bookingDialog.show(); //on hide, delete the dialog
  ...
  async reviewSubmitHandler(e) {
    ...
    try {
      ...
      await _UserAPI.default.addReview(email, rating.value, message);

      _Toast.default.show('review added!');
  ...
  reviewHandler(handyman) {
    ...
    this.reviewDialog.className = 'review-dialog'; //add content

    const dialogContent = (0, _litHtml.html)(_templateObject2(), this.name, this.reviewSubmitHandler.bind(this), handyman.email);
    (0, _litHtml.render)(dialogContent, this.reviewDialog); //append to document.body

    document.body.append(this.reviewDialog); //show the dialog

    this.reviewDialog.show(); //on hide, delete the dialog
  ...
  moreInfoHandler(handyman) {
    ...
    this.handymanDialog.className = 'handyman-dialog'; //add content

    const dialogContent = (0, _litHtml.html)(_templateObject3(), handyman.firstName, handyman.lastName, handyman.firstName, handyman.lastName, handyman.rating == null ? (0, _litHtml.html)(_templateObject4()) : (0, _litHtml.html)(_templateObject5(), handyman.rating), handyman.field, handyman.price, handyman.experience, handyman.neatness, handyman.safety, handyman.policeCheck == "false" ? (0, _litHtml.html)(_templateObject6()) : (0, _litHtml.html)(_templateObject7()), handyman.pets == "false" ? (0, _litHtml.html)(_templateObject8()) : (0, _litHtml.html)(_templateObject9()), () => this.reviewHandler(handyman), () => this.bookHandler(handyman));
    (0, _litHtml.render)(dialogContent, this.handymanDialog); //append to document.body

    document.body.append(this.handymanDialog); //show the dialog

    this.handymanDialog.show(); //on hide, delete the dialog
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject10(), JSON.stringify(_Auth.default.currentUser), this.handymen == null ? (0, _litHtml.html)(_templateObject11()) : (0, _litHtml.html)(_templateObject12(), this.handymen.map(handyman => (0, _litHtml.html)(_templateObject13(), handyman.firstName, handyman.lastName, handyman.firstName, handyman.lastName, handyman.field, handyman.price, () => this.moreInfoHandler(handyman), () => this.bookHandler(handyman)))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new HandymenView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../HandymanAPI":"HandymanAPI.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _handymen = _interopRequireDefault(require("./views/pages/handymen"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/handymen":"views/pages/handymen.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
class App {
  constructor() {
    ...
    this.name = "Fixeroo";
    this.version = "1.0.0";
    this.apiBase = 'https://qriit84nz2.execute-api.us-east-1.amazonaws.com'; //the root div we want to insert et into
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", this.menuClick, this.menuClick, this.menuClick, this.menuClick, () => _Auth.default.signOut(), this.menuClick);
  }
